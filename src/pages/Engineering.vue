...
export default {
  ...
  computed: {
    ...
    pageTitle () {
      return this.$gettext('Inženjerska informatika')
    },
    ogDescription () {
      return this.$gettext('ENGINEERING_TEXT')
    },
    ogImage () {
      return 'https://eczavrsni.website/static/social/' + this.$i18n.activeLocale + '/engineering.jpg'
    },
    ogUrl () {
